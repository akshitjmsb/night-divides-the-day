// Icon SVG string generators for vanilla JS
export const iconSvgs = {
    worldOrder: `
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="12" cy="12" r="10" />
            <path d="M2 12h20" />
            <path d="M7 4.5c2.5 2.5 2.5 7.5 0 10" />
            <path d="M17 4.5c-2.5 2.5-2.5 7.5 0 10" />
            <path d="M7 19.5c2.5-2.5 7.5-2.5 10 0" />
            <path d="M7 4.5c-2.5 2.5-2.5 7.5 0 10" />
            <path d="M12 2v20" />
